...
![p(z) = p(x|z)\cdot p(z)](https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_black&space;p(z)&space;=&space;p(x|z)\cdot&space;p(z)#gh-dark-mode-only)
![p(z) = p(x|z)\cdot p(z)](https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;p(z)&space;=&space;p(x|z)\cdot&space;p(z)#gh-light-mode-only)
