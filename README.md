...
<img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;p(z)&space;=&space;p(x|z)\cdot&space;p(z)" title="\bg_white p(z) = p(x|z)\cdot p(z)" /><!-- <img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_black&space;p(z)&space;=&space;p(x|z)\cdot&space;p(z)" title="\bg_black p(z) = p(x|z)\cdot p(z)" /> -->
, where we try to model the original distribution of the data with `p`
, such that we can draw samples with 
<!-- <img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_black&space;z&space;\sim&space;p(z)" title="\bg_black z \sim p(z)" />  --><img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;z&space;\sim&space;p(z)" title="\bg_white z \sim p(z)" />
and 
<!-- <img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_black&space;x&space;\sim&space;p(x|z)" title="\bg_black x \sim p(x|z)" /> --><img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;x&space;\sim&space;p(x|z)" title="\bg_white x \sim p(x|z)" />
...
<!-- <img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_black&space;[\mu_x,&space;\sigma_x]&space;\sim&space;x&space;" title="\bg_black [\mu_x, \sigma_x] \sim x " /> --><img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;[\mu_x,&space;\sigma_x]&space;\sim&space;x" title="\bg_white [\mu_x, \sigma_x] \sim x" />
. Then a likelihood distribution is created from this decoder output, 
<!-- <img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_black&space;\mathcal{N}(\mu_x,&space;\sigma_x)" title="\bg_black \mathcal{N}(\mu_x, \sigma_x)" /> --><img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;\mathcal{N}(\mu_x,\sigma_x)" title="\bg_white \mathcal{N}(\mu_x,\sigma_x)" />
