...
<img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;p(z)&space;=&space;p(x|z)\cdot&space;p(z)" title="\bg_white p(z) = p(x|z)\cdot p(z)" />
...
<img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;z&space;\sim&space;p(z)" title="\bg_white z \sim p(z)" />
and 
...
<img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;x&space;\sim&space;p(x|z)" title="\bg_white x \sim p(x|z)" />
...
<img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;q(z|x)" title="\bg_white q(z|x)" />
.
...
<img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;\mathcal{L}_{ELBO}&space;=&space;\mathcal{L}_{KL}&space;&plus;&space;\mathcal{L}_{recon}" title="\bg_white \mathcal{L}_{ELBO} = \mathcal{L}_{KL} + \mathcal{L}_{recon}" />
...
<img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;\mathcal{L}_{KL}&space;=&space;KL(q||p)&space;=&space;\mathbb{E}\left[log\frac{p(z)}{q(z|x)}\right]" title="\bg_white \mathcal{L}_{KL} = KL(q||p) = \mathbb{E}\left[log\frac{p(z)}{q(z|x)}\right]" />
...
<img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;[\mu_x,&space;\sigma_x]&space;\sim&space;x" title="\bg_white [\mu_x, \sigma_x] \sim x" />
...
<img src="https://latex.codecogs.com/png.image?\dpi{120}&space;\bg_white&space;\mathcal{N}(\mu_x,\sigma_x)" title="\bg_white \mathcal{N}(\mu_x,\sigma_x)" />
